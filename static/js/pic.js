...
window.onload = function () {
    ...
    for (i = 0; i < aLi.length; i++) {
        ...
        aLi[i].onclick = function () {
            ...
            // oFrame.innerHTML = '<img src="/static/images/'+(this.index + 1)+'.jpg" />';
            var photo;
            for (var y=0;  y<list.length; y++) {
                photo = list[y]
                console.log(photo['road']);

                oFrame.innerHTML = '<img src="'+photo['road']+'" />';
            }
    ...
    aBli[0].onclick = function () {
        ...
        oFrame.innerHTML = '<img src="/static/images/' + iNow + '.jpg" width="100%" height="100%" />';
    };
